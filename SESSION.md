...
This file is the "save game" for our learning sessions. When you say **"end session"**, I overwrite the snapshot below so we can pick up exactly where we left off next time. When you come back, just say **"resume"** (or open this file) and we continue.
...
| Date | Module | Summary |
|---|---|---|
| 2026-07-10 | Setup | Workspace + course + TechShop DB scripts created. |
